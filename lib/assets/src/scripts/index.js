...
$(document).ready(function() {
  $('div.metric-definitions-inner').css('height', 'auto');
  var thisHeight = $('div.metric-definitions-inner').height();
  $('div.metric-definitions-inner').css('height', 30);
  $("button").on('click', function() {
    $('div.metric-definitions-inner').animate({
      'height': thisHeight
    })
  });
});
